<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Site.master" CodeBehind="Default.aspx.cs" Inherits="CentralMonitor._Default" %>
    ...
    <div class="container">
      ...
      <div class="row">
        ...
        <div class="col-md-4">
          ...
          <p>The DevExpress Bootstrap Control Suite includes a GridView with powerful data analysis and display features, Data Editors with automatic layout management, and Navigation Controls. </p>
